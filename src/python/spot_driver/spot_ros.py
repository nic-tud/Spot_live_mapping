...
class SpotROS:
    ...
    def SideImageCB(self, results):
        ...
        if data:
            ...
            image_msg4, camera_info_msg4 = getImageMsg(data[2], self.spot_wrapper)
            self.left_depth_in_visual_pub.publish(image_msg4)
            self.left_depth_in_visual_info_pub.publish(camera_info_msg4)
            image_msg5, camera_info_msg5 = getImageMsg(data[3], self.spot_wrapper)
            self.right_depth_in_visual_pub.publish(image_msg5)
            self.right_depth_in_visual_info_pub.publish(camera_info_msg5)
    ...
    def RearImageCB(self, results):
        ...
        if data:
            ...
            # mage_msg1, camera_info_msg1 = getImageMsg(data[0], self.spot_wrapper)
            ...
            self.back_depth_in_visual_pub.publish(image_msg2)
            self.back_depth_in_visual_info_pub.publish(camera_info_msg2)
    ...
    def main(self):
        ...
        self.frontleft_image_pub = rospy.Publisher(
            "camera/frontleft/compressed", CompressedImage, queue_size=10
        )
        """
        self.frontleft_image_pub = rospy.Publisher(
        ...
        self.frontleft_depth_in_visual_pub = rospy.Publisher(
            "depth/frontleft/depth_in_visual/image", Image, queue_size=10
        )
        self.frontright_depth_in_visual_pub = rospy.Publisher(
            "depth/frontright/depth_in_visual/image", Image, queue_size=10
        )
        self.left_depth_in_visual_pub = rospy.Publisher(
            "depth/left/depth_in_visual/image", Image, queue_size=10
        )
        self.right_depth_in_visual_pub = rospy.Publisher(
            "depth/right/depth_in_visual/image", Image, queue_size=10
        )
        self.back_depth_in_visual_pub = rospy.Publisher(
            "depth/back/depth_in_visual/image", Image, queue_size=10
        )
