        ...
        for source in front_image_sources:
            if "depth" in source:
                self._front_image_requests.append(
                    ...
                    #build_image_request(source, image_format=image_pb2.Image.FORMAT_JPEG)
                )
            else:
                self._front_image_requests.append(
                    build_image_request(source, image_format=image_pb2.Image.FORMAT_RAW, pixel_format=3)
                    #build_image_request(source, image_format=image_pb2.Image.FORMAT_JPEG)
                )            

        #self._side_image_requests = [build_image_request("right_fisheye_image", image_format=image_pb2.Image.PIXEL_FORMAT_RGB_U8)]
